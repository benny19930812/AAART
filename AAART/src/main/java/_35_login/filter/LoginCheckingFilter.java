...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "mustLogin1", value = "/_35_listActs/*"), 
				@WebInitParam(name = "mustLogin2", value = "/_35_ShoppingCart/*"), 
				@WebInitParam(name = "mustLogin3", value = "/_35_orderProcess/*"),
				@WebInitParam(name = "mustLogin4", value = "/_35_productMaintain/*")				
		})
